---
name: update-docs
description: Internal documentation-maintenance step — update project documents made stale by an implementation before handoff. Invoked from ship-issue.
...
5. **Re-read** — read each edited document start to finish and confirm it reads naturally as a whole, with no duplicated or contradictory statements left by successive edits
